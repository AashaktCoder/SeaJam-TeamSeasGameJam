...
def Menu(WIN, Text, Main):
    ...
    def Difficulty(run1):
        ...
        while run2:
            ...
            Text("Easy", 215, 223, (0, 0, 0), 50)
            pygame.draw.rect(WIN, (0, 0, 0), [175, 300, 150, 75], 8, 10)
            Text("Medium", 193, 310, (0, 0, 0), 50)
            pygame.draw.rect(WIN, (0, 0, 0), [175, 382, 150, 75], 8, 10)
            Text("Hard", 197, 390, (0, 0, 0), 50)
            ...
            MouseClick(175, 218, 150, 75, mouse, lambda: SetDifficulty(985))
            MouseClick(175, 300, 150, 75, mouse, lambda: SetDifficulty(945))
            MouseClick(175, 382, 150, 75, mouse, lambda: SetDifficulty(900))
